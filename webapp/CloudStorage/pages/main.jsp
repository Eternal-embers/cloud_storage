...
<body>
    ...
    <div id="task-window">
            ...
            <div class="window-shrink">
                <svg t="1723008816362" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1468">
                    <path
                        d="M885.333 85.333h-576A53.393 53.393 0 0 0 256 138.667V256H138.667a53.393 53.393 0 0 0-53.334 53.333v576a53.393 53.393 0 0 0 53.334 53.334h576A53.393 53.393 0 0 0 768 885.333V768h117.333a53.393 53.393 0 0 0 53.334-53.333v-576a53.393 53.393 0 0 0-53.334-53.334z m-160 800A10.667 10.667 0 0 1 714.667 896h-576A10.667 10.667 0 0 1 128 885.333v-576a10.667 10.667 0 0 1 10.667-10.666h576a10.667 10.667 0 0 1 10.666 10.666zM896 714.667a10.667 10.667 0 0 1-10.667 10.666H768v-416A53.393 53.393 0 0 0 714.667 256h-416V138.667A10.667 10.667 0 0 1 309.333 128h576A10.667 10.667 0 0 1 896 138.667z"
                        p-id="1469"></path>
                </svg>
            </div>

            <div class="window-full">
                <svg t="1723010527291" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="26050">
                    <path
    ...
    <div id="preview">
        <div class="preview-window txt-preview">
            <div class="window-header">
                <div class="preview-title">
                    <svg t="1718905281923" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        p-id="143777">
                        <path
    ...
    `storage_quota` DOUBLE NOT NULL DEFAULT '0',
    `used_storage` DOUBLE NOT NULL DEFAULT '0',
    `user_status` VARCHAR(50) DEFAULT 'normal',
    `source_from` VARCHAR(50) DEFAULT 'email',
    `bind_status` TINYINT(1) NOT NULL DEFAULT '0',
    ...
    file_path VARCHAR(1024) NOT NULL comment '文件在服务器中的相对路径'
    file_size bigint default 0 comment '单位字节'
    file_type VARCHAR(10) comment '文件类型，拓展名或文件夹类型'
    ...
    <div id="preview-control">
        <div class="main">
            <div class="preview-control-header">
                <div class="preview-control-icon">
                    <svg t="1723181787875" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        p-id="32902">
                        <path
                            d="M312.32 482.986667h-59.733333a25.6 25.6 0 0 1 0-51.2h59.733333a25.6 25.6 0 0 1 0 51.2zM312.32 633.173333h-59.733333a25.6 25.6 0 0 1 0-51.2h59.733333a25.6 25.6 0 1 1 0 51.2zM312.32 783.36h-59.733333a25.6 25.6 0 0 1 0-51.2h59.733333a25.6 25.6 0 1 1 0 51.2zM773.12 482.986667h-341.333333a25.6 25.6 0 0 1 0-51.2h341.333333a25.6 25.6 0 0 1 0 51.2zM773.12 633.173333h-341.333333a25.6 25.6 0 0 1 0-51.2h341.333333a25.6 25.6 0 0 1 0 51.2zM773.12 783.36h-341.333333a25.6 25.6 0 0 1 0-51.2h341.333333a25.6 25.6 0 0 1 0 51.2z"
                            p-id="32903"></path>
                        <path
                            d="M902.826667 943.786667H121.173333a83.626667 83.626667 0 0 1-85.333333-87.04V177.493333a83.626667 83.626667 0 0 1 85.333333-87.04h781.653334a83.626667 83.626667 0 0 1 85.333333 87.04v679.253334a83.626667 83.626667 0 0 1-85.333333 87.04zM121.173333 141.653333a32.426667 32.426667 0 0 0-34.133333 35.84v679.253334a34.133333 34.133333 0 0 0 34.133333 35.84h781.653334a32.426667 32.426667 0 0 0 34.133333-35.84V177.493333a34.133333 34.133333 0 0 0-34.133333-35.84z"
                            p-id="32904"></path>
                        <path d="M962.56 322.56H61.44a25.6 25.6 0 1 1 0-51.2h901.12a25.6 25.6 0 1 1 0 51.2z"
                            p-id="32905">
                        </path>
                    </svg>
                </div>
                <div class="preview-control-title">预览文件列表</div>
            </div>
            <div class="preview-content"></div>
        </div>
        <div id="preview-control-close">
            <svg t="1723256734106" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8007">
                <path
                    d="M448.66 253.59l34.11 34.12-223.12 223.12 223.12 223.15-34.11 34.08-223.09-223.15-34.12-34.08 34.12-34.09 223.09-223.15zM757.34 253.59l34.11 34.12-223.11 223.12 223.11 223.15-34.11 34.08-223.09-223.15-34.11-34.08 34.11-34.09 223.09-223.15z"
                    p-id="8008"></path>
            </svg>
        </div>
    </div>
